	...
	class WP_Import extends WP_Importer {
		...
		function process_terms() {
			...
			foreach ( $this->terms as $term ) {
				...
				$name         = $term['term_taxonomy'];
				$pattern      = '/^pa_/i';
				$result_match = preg_split( $pattern, $name );
				if ( $result_match && !taxonomy_exists( $name ) ) {
					...
					$taxonomy_data = array(
						...
						'sort'                  => false,
						'public'                => 1,
						'show_in_nav_menus'     => 1 && apply_filters( 'woocommerce_attribute_show_in_nav_menus', false, $name ),
						'capabilities'          => array(
