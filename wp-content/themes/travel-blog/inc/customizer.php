...
function travel_blog_customize_preview_js() {
	wp_enqueue_script( 'travel_blog_customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
